...
## 2. Get Shared Holidays Between Two Countries
...
## 3. Get Count of Non-Weekend Holidays

**Endpoint:** `GET /api/holidays/non-weekend/{year}?countryCodes=NL,DE`  
...
## 4. Get Last Number of Celebrated Holidays for a Country

**Endpoint:** `GET /api/holidays/last-number-of-holidays/{countryCode}?numberOfHolidays=3`  
...
| TC-3.4    | Non supported one country code             | countryCode2=SA                     | 400 Bad Request, error message                   |
...
### 5.1 SharedHoliday Object
- `date`: string, format `YYYY-MM-DD`
- `localNameCountry1`: string
- `localNameCountry2`: string

### 5.2 CountryHolidayCount Object
...
## 6. Negative Test Scenarios (General)
