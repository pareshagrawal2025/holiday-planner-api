...
public interface HolidayServiceContract {
    ...
    List<Holiday> getLastNumberOfHolidays(String countryCode, Integer inputNumberOfHolidays);
    List<CountryHolidayCount> getNonWeekendHolidayCounts(int year, String countryCodes);
